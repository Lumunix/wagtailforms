...
from wagtailforms.streamfield import FormFieldsStreamField
from wagtailforms.utils.general import get_slug_from_string
...
class AbstractForm(models.Model):
    ...
    def get_data_fields(self):
        ...
        if getattr(settings, "WAGTAILFORMS_SHOW_FORM_REFERENCE", False):
