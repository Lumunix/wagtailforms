...
class CopyViewTestCase(AppTestCase):
    ...
    def setUp(self):
        ...
        self.copy_url = reverse("wagtailforms:forms_copy", kwargs={"pk": self.form.pk})
        self.invalid_copy_url = reverse("wagtailforms:forms_copy", kwargs={"pk": 100})
...
class CopyViewPermissionTestCase(AppTestCase):
    ...
    def setUp(self):
        ...
        self.copy_url = reverse("wagtailforms:forms_copy", kwargs={"pk": form.pk})
